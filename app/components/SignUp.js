...
export function SignUp() {
    ...
    return (
        ...
        <form onSubmit={handleSignUp}>
          ...
          <input className="p-4 w-full border rounded-lg mb-6" type="username" name="username" id="username" placeholder="Username" maxLength={30} autoComplete='off' autoCapitalize="off" required/>
  
          <label htmlFor="password" className="block text-sm font-medium text-white mb-3">Password</label>
          <input className="p-4 w-full border rounded-lg mb-6" type="password" name="password" id="password" placeholder="Password" maxLength={44} autoComplete='off' autoCapitalize="off" required/>
  
          <label htmlFor="repeatPassword" className="block text-sm font-medium text-white mb-3">Repeat Password</label>
          <input className="p-4 w-full border rounded-lg mb-6" type="password" name="repeatPassword" id="repeatPassword" placeholder="Repeat Password" maxLength={44} autoComplete='off' autoCapitalize="off" required/>
